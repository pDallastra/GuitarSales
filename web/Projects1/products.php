...
<body>
    ...
    <button type="submit" class="btn btn-block btn-danger btn-lg" style="width: 10rem;height: 4rem;border-radius: 5rem;" onclick="orderForm()">I want to order a Guitar!</button>
  </div>
</section>
